export const input = `pale cyan bags contain 2 posh black bags, 4 wavy gold bags, 2 vibrant brown bags.
...
export const sample1 = `light red bags contain 1 bright white bag, 2 muted yellow bags.
